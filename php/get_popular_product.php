		...
		echo '<div class="thumb-wrapper cool">';
			echo '<div class="thumb-content">';
				if ($category == "Necklace") {
					echo '<a href="necklace.php" class="btn">View All</a>';
