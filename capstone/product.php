                                        ...
                                        if ($result->num_rows > 0) {
                                            ...
                                            while ($row = $result->fetch_assoc()) {
                                                ...
                                                <div class="container p-0 m-0">
                                                    <div class="thumb-wrapper border border-dark m-0"
                                                         style="width: 200px;">
...
<script>
    ...
    function createProductElement(products) {
        ...
        products.forEach(productData => {
            ...
            thumbWrapperDiv.classList.add('thumb-wrapper', 'border', 'border-dark', 'm-0');
            thumbWrapperDiv.style.width = '200px';

            const wishIconSpan = document.createElement('span');
            wishIconSpan.classList.add('wish-icon');
            wishIconSpan.innerHTML = '<i class="fa fa-heart-o"></i>';
            ...
            viewButton.classList.add('rounded-0', 'btn', 'btn-outline-success', 'btn-sm');
            viewButton.textContent = 'View';

            linkButton.appendChild(viewButton);
            thumbContentDiv.appendChild(titleHeading);
            thumbContentDiv.appendChild(priceParagraph);
            thumbContentDiv.appendChild(linkButton);

            thumbWrapperDiv.appendChild(wishIconSpan);
