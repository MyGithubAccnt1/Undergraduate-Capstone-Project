...
if (isset($_POST['maxPrice'], $_POST['minPrice'])) {
    ...
    $sql = "SELECT price, title, thumbnail FROM product WHERE category = 'Table' AND price BETWEEN ? AND ?";
				                        ...
				                        <div class="carousel-inner" style="width: 100%">
				                            <div class="item carousel-item active" style="overflow-x: auto;">
				                                <div id="productSection" class="d-flex flex-direction-row gap-4"
				                                    ...
				                                    <?php
				                                    include('./php/connect.php');
				                                    $sql = "SELECT price, title, thumbnail FROM product WHERE category = 'Table'";
