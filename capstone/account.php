	                    ...
	                    <div class="my-5">
	                    	<a href="logout.php">
	                        	<div class="d-flex justify-content-end">
	                        	  	<button type="submit" class="btn-main py-1 my-3 w-25 rounded-pill">Logout</button>
	                        	</div>
	                        </a>
	                                ...
	                                <div class="bg-secondary-soft px-4 py-5 rounded">
	                                    <div class="row g-3">
	                                        ...
	                                        <div class="d-flex justify-content-center">
				                        	  	<button type="submit" class="btn-main py-1 my-3 w-25 rounded-pill">Update Details</button>
				                        	</div>
	                                    </div>
	                                </div>
	                            </div>
	                            ...
	                            <div class="col">
	                                <div class="bg-secondary-soft px-4 py-5 rounded">
	                                    <div class="row g-3">
	                                        ...
	                                        <div class="d-flex justify-content-center">
				                        	  	<button type="submit" class="btn-main py-1 my-3 w-25 rounded-pill">Update Password</button>
				                        	</div>
	                                    </div>
	                                </div>
	                            </div>
