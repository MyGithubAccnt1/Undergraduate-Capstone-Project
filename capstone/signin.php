								...
								<div class="tab-pane fade show active signin_navigation border-0" id="login-tab-pane" role="tabpanel" aria-labelledby="login-tab" tabindex="0">
									<form action="" id="login">
					    	  			...
					    	  			<div class="d-flex justify-content-center">
					    	  			  	<button type="submit" class="btn-main py-1 my-3 w-75 rounded-pill">Sign in</button>
					    	  			</div>
				    	  			</form>
								</div>
									...
									<form action="" id="register">
		    	  					    ...
		    	  					    <div class="row m-0 p-0">
					    	  			    <div class="col d-flex justify-content-center align-items-center">
					    	  			        <button type="button" style="font-size: 0.74rem; border: none; margin: 0; padding: 0; background-color: inherit; color: #fff;" title="View our Terms & Conditions" id="accept-button">Accept our Terms & Conditions</button>
					    	  			    </div>
					    	  			</div>
					    	  			<div class="d-flex justify-content-center">
					    	  			  	<button type="submit" class="btn-main py-1 my-3 w-75 rounded-pill">Register</button>
					    	  			</div>
									</form>
								</div>
							</div>
				...
				<div class="row">
					<div class="col-sm-12 col-md-6 col-lg-5 mx-auto text-dark cool">
						...
						<div class="row">
							...
							<p class="text-start">These terms and conditions outline the rules and regulations for the use of Saint Benedict Medallion's Website, located at http://20.205.112.210/.</p>
